...
public class StudentManagementSystem extends JFrame {
    ...
    public StudentManagementSystem() {
        ...
        contactDisplay = new JTextArea(45, 35);
    ...
    private boolean showLogin() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            if (username.equals("Shihab") && password.equals("95")) {
    ...
    private void displayMainMenu() {
        ...
        JButton addContactButton = new JButton("[1] Add New Student Information   ");
        ...
        JButton listContactsButton = new JButton("[2] List of all Student                        ");
        ...
        JButton searchContactButton = new JButton("[3] Search  Student Data                 ");
        ...
        JButton editContactButton = new JButton("[4] Edit a Student Data                    ");
        ...
        JButton deleteContactButton = new JButton("[5] Delete a Student Information    ");
        ...
        JButton exitButton = new JButton("[0] Exit                                   (⊙_◎)");
    ...
    private void displayAddContactForm() {
        ...
        int result = JOptionPane.showConfirmDialog(null, addContactPanel, "Add a New Student Information ", JOptionPane.OK_CANCEL_OPTION);
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            Contact contact = new Contact(name, phone, address, id);
    ...
    private void listAllContacts() {
        ...
        for (Contact contact : contacts) {
            String formattedContact = String.format("Name: %s\nPhone: %s\nAddress: %s\nID: %s\n\n",
                    contact.getName(), contact.getPhone(), contact.getAddress(), contact.getid());
            contactDisplay.append(formattedContact);
        }
    }

    private void displaySearchContactForm() {
        String query = JOptionPane.showInputDialog("Enter the name of the Student to search:");
    ...
    private void displayEditContactForm() {
        String query = JOptionPane.showInputDialog("Enter the name of the Student to edit:");
    ...
    private void displayEditContactDialog(Contact contact) {
        ...
        editContactPanel.add(new JLabel("ID:"));
        JTextField idField = new JTextField(contact.getid());
        editContactPanel.add(idField);
    ...
    private void displayDeleteContactForm() {
        String query = JOptionPane.showInputDialog("Enter the name of the Student to delete: ");
...
class Contact implements Serializable {
    ...
    public Contact(String name, long phone, String address, String id) {
        this.name = name;
        this.phone = phone;
